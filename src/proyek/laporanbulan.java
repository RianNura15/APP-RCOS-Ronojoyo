 ...
 * @author dell
 */
public class laporanbulan extends javax.swing.JFrame {
    private Connection conn;
    private Statement st;
    private ResultSet rs;
    private DefaultTableModel model;
    /**
     * Creates new form laporanbulan
     */
    public laporanbulan() {
        initComponents();
    ...
    private void initComponents() {
        ...
        txttanggal1.setFont(new java.awt.Font("Square721 BT", 0, 24)); // NOI18N
        ...
        txttanggal.setFont(new java.awt.Font("Square721 BT", 0, 24)); // NOI18N

        jLabel1.setFont(new java.awt.Font("Square721 BT", 1, 24)); // NOI18N
        jLabel1.setForeground(new java.awt.Color(255, 255, 255));
        jLabel1.setText("Masukkan Tanggal");

        tabelbulanan.setFont(new java.awt.Font("Dialog", 0, 24)); // NOI18N
        tabelbulanan.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "No", "No Faktur", "Nama", "Produk", "Ukuran", "Harga", "Jumlah Pesanan", "Total"
            }
        ));
        tabelbulanan.setRowHeight(50);
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addComponent(btncari, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 223, javax.swing.GroupLayout.PREFERRED_SIZE)
                                ...
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    ...
                                    .addComponent(txttanggal, javax.swing.GroupLayout.DEFAULT_SIZE, 299, Short.MAX_VALUE)
                                ...
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addComponent(txttanggal1, javax.swing.GroupLayout.PREFERRED_SIZE, 300, javax.swing.GroupLayout.PREFERRED_SIZE))))
                        .addGap(262, 262, 262))))
        );
...
private void export(){
        ...
        if (retrival == JFileChooser.APPROVE_OPTION) {
            ...
            try{
                ...
                TableModel tModel = tabelbulanan.getModel();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(laporanbulan.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new laporanbulan().setVisible(true);
            }
        });
    }
 ...
 private void open_db() {
    ...
    private void tampilkan_data() {
        ...
        try {
            open_db();
             String sql = "SELECT * FROM transaksi WHERE tanggal > '"+txttanggal.getText()+"' AND tanggal< '"+txttanggal1.getText()+"'";
            st = (Statement) conn.createStatement();
           ...
           tabelbulanan.setModel(tabelmapel);
        } catch (Exception e) {
        }
    }
}
